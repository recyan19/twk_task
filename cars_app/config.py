...
class Config:
    MONGODB_URI = os.environ.get('MONGODB_URI', f'mongodb://{MONGODB_HOST}:27017/cars')
...
class TestConfig(Config):
    MONGODB_URI = os.environ.get('MONGODB_TEST_URI', f'mongodb://{MONGODB_HOST}:27017/cars_test')
    DEBUG = True
